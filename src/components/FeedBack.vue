  ...
  <div class="h-[500px] w-[100%]">
    <div class="h-[435px] w-[80%] m-auto flex flex-col items-start">
      <div class="h-[300px] w-[100%]">
        <h2 class="text-[64px] leading-[5.5rem] uppercase text-[#441D06] font-thin w-[800px]">
          Будем рады ответить на все ваши вопросы
        </h2>
      </div>
      <p class="text-[#000] text-[24px] font-light uppercase leading-[2.2rem] text-center w-[35%] m-auto">
      ...
      <div class="h-[145px] w-[100%] flex justify-end items-center">
        <input v-model="username" type="text"
          ...
          placeholder="Имя" />
        <input v-model="usernubmer" type="email"
        ...
        <div @click="send()" class="flex items-center h-[100px] w-[300px]">
          ...
          <button class="ml-[55px] mr-[10px] z-[10] text-[#000] text-[18px] font-semibold">
            Отправить
          </button>
